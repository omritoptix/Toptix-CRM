...
}; ko.validation.rules.date = { validator: function (a, b) { return d.isEmptyVal(a) || b && !/Invalid|NaN/.test(new Date(a)) }, message: "Please enter a proper date" }; ko.validation.rules['formattedDate'] = {
...
}; ko.validation.rules.dateISO = { validator: function (a, b) { return d.isEmptyVal(a) || b && /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test(a) }, message: "Please enter a proper date" }; ko.validation.rules.number = { validator: function (a, b) { return d.isEmptyVal(a) || b && /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(a) }, message: "Please enter a number" };
